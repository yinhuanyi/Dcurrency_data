...
PLAYBOOK_SQL_INFO_LOG = os.path.join(LOG_DIR, 'playbook_sql_info.log')
PLAYBOOK_SQL_ERROR_LOG = os.path.join(LOG_DIR, 'playbook_sql_error.log')
...
KAFKA_COMMIT_LOG = os.path.join(LOG_DIR, 'kafka_commit.log')
